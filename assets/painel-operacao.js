(function () {
  ...
  function reportHtml() {
    ...
    return '<!doctype html><html><head><meta charset="utf-8"><title>Relatório Operacional Diário</title><style>' +
      ...
      '</style></head><body><header><div class="sup">Prefeitura Municipal de Carmo/RJ</div><h1>Relatório Operacional Diário</h1><div class="meta">Coordenação Municipal de Combate às Endemias • Data: ' + escapeHtml(state.date) + '</div></header>' +
